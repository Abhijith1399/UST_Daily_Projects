...
public:
	...
	LeavMS(string n, char g, int a, int pno, int id, int s, string dept, int pt, int pf, int vp, int nday, int hours, int days) :
		Employee(n, g, a, pno, id, s, dept),
...
int main()
{
	...
	LeavMS lobj("Abhijt", 'm', 22, 7777, 293956, 26000, "AM", 200, 2600, 100000, 30, 8, 890);
	lobj.dispLMS();
